...
public final class AInheritsProduction extends PInheritsProduction
{
    private TInherits _inherits_;
    private TFrom _from_;

    public AInheritsProduction()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInheritsProduction(
    ...
    {
        ((Analysis) sw).caseAInheritsProduction(this);
    }
